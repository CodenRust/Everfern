        ...
        <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 20 }}>
                {[
                    ...
                    { id: 'everfern', label: 'EverFern Cloud', desc: 'Managed frontier models, optimized for EverFern.', icon: <Image unoptimized src="/images/logos/everfern-withoutbg.png" alt="" width={24} height={24} style={{ filter: settingsEngine !== 'everfern' ? 'grayscale(1) opacity(0.6)' : 'none', transition: 'all 0.3s' }} /> },
