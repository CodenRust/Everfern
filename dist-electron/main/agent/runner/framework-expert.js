...
exports.FrameworkExpert = void 0;
exports.getFrameworkExpert = getFrameworkExpert;
/**
    ...
    recommendFramework(requirements) {
        ...
        const scored = candidates.map(template => {
            ...
            for (const feature of requirements.features) {
                if (template.techStack.some(tech => tech.toLowerCase().includes(feature.toLowerCase()))) {
                    score += 2;
                }
            }
            // Complexity matching
...
exports.FrameworkExpert = FrameworkExpert;
// Singleton instance
let frameworkExpertInstance = null;
function getFrameworkExpert() {
