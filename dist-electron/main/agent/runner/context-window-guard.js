...
exports.ContextWindowGuard = void 0;
exports.getContextWindowForModel = getContextWindowForModel;
exports.getContextWindowGuard = getContextWindowGuard;
...
class ContextWindowGuard {
    ...
    getUsage(tokens) {
        const effectiveMax = Math.floor(this.config.modelContextWindow * (1 - this.config.safetyMargin));
        return {
            used: tokens,
...
exports.ContextWindowGuard = ContextWindowGuard;
// Singleton factory
const guards = new Map();
function getContextWindowGuard(model) {
    if (!guards.has(model)) {
