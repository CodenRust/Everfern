...
exports.IntelligentErrorRecovery = exports.RetryMechanism = exports.DEFAULT_RETRY_CONFIG = exports.CircuitBreaker = exports.CircuitBreakerState = exports.ErrorRecoveryStrategy = void 0;
exports.createErrorRecoverySystem = createErrorRecoverySystem;
/**
 * Error recovery strategies
 */
var ErrorRecoveryStrategy;
(function (ErrorRecoveryStrategy) {
    ErrorRecoveryStrategy["USE_HEURISTICS"] = "heuristics";
    ErrorRecoveryStrategy["USE_CACHED_ASSESSMENT"] = "cached";
    ErrorRecoveryStrategy["USE_DEFAULT_SCORING"] = "default";
    ErrorRecoveryStrategy["SKIP_INTELLIGENT_ANALYSIS"] = "skip";
})(ErrorRecoveryStrategy || (exports.ErrorRecoveryStrategy = ErrorRecoveryStrategy = {}));
/**
...
class IntelligentErrorRecovery {
    ...
    constructor(circuitBreakerConfig, retryConfig) {
        this.circuitBreaker = new CircuitBreaker(circuitBreakerConfig?.failureThreshold, circuitBreakerConfig?.successThreshold, circuitBreakerConfig?.timeout);
     ...
     * Requirements: 8.1
     */
    async handleRelevanceAssessmentFailure(error, fallbackStrategy, content, context) {
     ...
     * Requirements: 8.1, 8.2
     */
    async handleNavigationDecisionFailure(error, context) {
     ...
     * Requirements: 8.1
     */
    handleLearningSystemFailure(error) {
     ...
     * Requirements: 8.1
     */
    handleCacheFailure(error, operation) {
     ...
     */
    createDefaultRelevanceAssessment(content, context) {
        return {
            overallScore: 50,
            categoryScores: {
                pricing: 50,
     ...
     */
    createHeuristicRelevanceAssessment(content, context) {
        let score = 50;
        if (content) {
 ...
 */
function createErrorRecoverySystem(circuitBreakerConfig, retryConfig) {
