...
exports.demonstrateSiteSelector = demonstrateSiteSelector;
const site_selector_1 = require("../site-selector");
...
async function demonstrateSiteSelector() {
    ...
    // Create components
    const urlClassifier = new url_classifier_1.URLClassifierImpl(config);
    const siteSelector = new site_selector_1.SiteSelectorImpl(mockAIClient, config, urlClassifier);
    // Research context
    const context = {
